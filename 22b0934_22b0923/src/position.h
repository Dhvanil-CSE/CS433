...
class Position {
   public:
    ...
    void move433(Move m, StateInfo& newSt);
    void do_move(Move m, StateInfo& newSt, bool givesCheck);
    void move433(Move m, StateInfo& newSt, bool givesCheck);
    void undo433(Move m);
...
inline void Position::move433(Move m, StateInfo& newSt) {move433(m,newSt,gives_check(m));}
